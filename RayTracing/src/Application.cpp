...
int main() {
	...
	auto matidi = Materialrepository::AddMat(std::shared_ptr<Material>(new Dieletric(1.0f/1.2f)));
	...
	auto water = std::shared_ptr<Geometry>(new Plate(la::vec3(0.5f, 0.06f, 0), la::vec3(0, 1, 0), 0.095f));
